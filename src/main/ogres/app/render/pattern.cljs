...
(defmethod pattern :lines [{:keys [id color] :or {color "currentColor"}}]
...
(defmethod pattern :circles [{:keys [id color] :or {color "currentColor"}}]
  [:pattern {:id id :pattern-units "userSpaceOnUse" :width 12 :height 12}
   [:circle {:cx 7 :cy 7 :r 3 :fill "none" :stroke color}]])

(defmethod pattern :crosses [{:keys [id color] :or {color "currentColor"}}]
  [:pattern {:id id :pattern-units "userSpaceOnUse" :width 12 :height 12}
   [:path
...
(defmethod pattern :caps [{:keys [id color] :or {color "currentColor"}}]
  [:pattern {:id id :pattern-units "userSpaceOnUse" :width 12 :height 12}
   [:path
...
(defmethod pattern :waves [{:keys [id color] :or {color "currentColor"}}]
  [:pattern {:id id :pattern-units "userSpaceOnUse" :width 10 :height 10}
   [:path
